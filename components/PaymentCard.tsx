...
const PaymentCard: React.FC<PaymentCardProps> = ({ data, docId }) => {
  ...
  return (
    ...
    >
      ...
      <div className="w-[75%] flex flex-col p-8 relative z-10 pl-16 pb-12">
        ...
        <div className="flex-1 flex flex-col justify-center px-4 space-y-8">
          ...
          {/* BANK NAME */}
          <div className="bg-[#fcfaf5] border border-[#D4AF37]/20 p-6 shadow-sm relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <div 
              ...
              className="cursor-pointer bg-[#0c0c0c] py-10 px-8 shadow-[0_30px_60px_rgba(0,0,0,0.5)] transition-all hover:bg-black active:scale-[0.99] relative overflow-hidden border-y-[2px] border-[#D4AF37]/60"
            >
          ...
          <div className="grid grid-cols-2 gap-8">
             <div className="border border-[#1a1a1a]/10 p-6 bg-[#f9f9f9] shadow-inner relative overflow-hidden flex flex-col justify-center">
               ...
               <h3 className="text-[28px] font-bold text-[#1a1a1a] uppercase tracking-tighter leading-none truncate font-luxury">{data.accountName || 'UNDEFINED'}</h3>
             </div>
             <div className="border border-[#D4AF37]/20 p-6 bg-[#fcfaf5] shadow-inner relative overflow-hidden flex flex-col justify-center">
               ...
               <div className="flex items-baseline gap-4">
                 ...
                 <h3 className="text-[48px] font-black text-[#1a1a1a] tracking-tighter leading-none tabular-nums">{formatCurrency(data.amount)}</h3>
               </div>
             </div>
          </div>
        </div>

        {/* BANK INDONESIA OVERSIGHT - OVERLAP FIX */}
        <div className="mt-8 flex items-center gap-6 bg-[#fdfbf7] border border-[#D4AF37]/30 p-4 relative overflow-hidden shadow-xl ring-1 ring-black/5 min-h-[160px]">
          <div className="flex-shrink-0 flex flex-col items-center relative z-10">
             <div className="bi-seal w-24 h-24 rounded-full flex items-center justify-center border-[3px] border-[#D4AF37] p-4 mb-2 shadow-lg bg-white overflow-hidden">
                <img src={biLogo} alt="BI" className="w-16 object-contain" />
             </div>
             <div className="bg-[#A50016] px-3 py-1.5 shadow-md border border-white/20">
               <span className="text-[7px] font-black text-white uppercase tracking-[0.4em]">RESMI & DIAWASI</span>
             </div>
          </div>

          <div className="flex-1 border-l border-[#D4AF37]/30 pl-6 py-1 relative z-10">
            <h5 className="text-[12px] font-black text-[#1a1a1a] tracking-[0.5em] uppercase mb-1.5 flex items-center gap-2">
              <span className="w-2.5 h-2.5 bg-[#004526] rounded-full"></span>
              PENGAWASAN BANK INDONESIA
            </h5>
            <p className="text-[12px] text-[#111] leading-relaxed font-bold italic text-justify opacity-90 font-luxury">
          ...
          <div className="flex-shrink-0 bg-white p-2 border-2 border-[#D4AF37]/30 shadow-lg flex items-center justify-center min-w-[100px] min-h-[100px] z-10">
            <img src={qrCodeUrl} alt="QR" className="w-20 h-20 grayscale" />
          </div>
        </div>
      </div>
      ...
      <div className="w-[25%] h-full relative overflow-hidden bg-[#0a0a0a] flex flex-col items-center justify-center p-6 border-l border-[#D4AF37]/30 shadow-[-20px_0_50px_rgba(0,0,0,0.5)]">
        <div className="absolute inset-0">
           <img src="https://spyro-soft.com/wp-content/uploads/2023/11/image-woman-call-to-bank-1.jpg" className="w-full h-full object-cover brightness-[0.8]" alt="CS" />
           <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/10 to-black/80"></div>
        </div>

        <div className="relative z-10 flex flex-col items-center text-center w-full">
          <div className="w-40 h-40 border-[5px] border-[#D4AF37]/50 rounded-full flex items-center justify-center overflow-hidden mb-6 shadow-xl relative p-1">
          ...
          <div className="space-y-4">
            <p className="text-[#D4AF37] text-[14px] font-heritage tracking-[0.4em] uppercase font-bold">Authentic</p>
            <p className="text-white text-[20px] font-bold tracking-[0.1em] uppercase font-luxury leading-none">Settlement</p>
          </div>
        </div>

        <div className="absolute bottom-8 left-0 right-0 px-8 text-center opacity-40">
           <p className="text-white text-[8px] font-medium tracking-[0.25em] uppercase">© 2025 Guccio Gucci S.p.A.</p>
        </div>
      </div>
    </div>
  );
