...
const PaymentCard: React.FC<PaymentCardProps> = ({ data, docId }) => {
  ...
  // Generate QR Code URL pointing to Bank Indonesia official site for authenticity
  ...
  return (
    ...
    >
      {/* Silver Frame Guide for Screenshots */}
      ...
      <div className="w-[75%] flex flex-col p-8 relative z-10 pl-16">
        ...
        <div className="flex-1 flex flex-col justify-center px-4 space-y-10">
          ...
          {/* Account Number Box (Optimized for 16+ digits) */}
          <div className="relative">
            ...
            >
              ...
              <h2 className="text-[44px] font-bold tracking-[0.2em] text-white leading-none tabular-nums text-center relative z-10 drop-shadow-[0_4px_4px_rgba(0,0,0,0.6)] font-heritage break-all">
        ...
        {/* Bank Indonesia Oversight Section */}
      ...
      <div className="w-[25%] h-full relative overflow-hidden bg-[#0a0a0a] flex flex-col items-center justify-center p-6 border-l border-[#D4AF37]/30 shadow-[-20px_0_50px_rgba(0,0,0,0.5)]">
        {/* UPDATED IMAGE SOURCE - Woman calling bank */}
        <div className="absolute inset-0">
           ...
           />
           {/* Thinner overlay to keep the new photo visible */}
